# Actividades. Transformación del modelo e/r a relacional.
## Actividad 1. 
**Cursos de formación.**  
...
Un curso puede tener como prerrequisito haber realizado otro(s) previamente, y, a su vez la realización de un curso puede ser prerrequisito de otros. Uno curso que es un prerrequisito de otro puede serlo de forma obligatoria o sólo recomendable.
...
![Diseño de bases de datos.](img/actividades/ud4_act_img1.png)

Se pide transformación a esquema relacional.
## Actividad 2.
**Campeonato de ajedrez.**  
El club de Ajedrez de Villatortas de Arriba, ha sido encargado por la Federación Internacional de Ajedréz de la organización de los próximos campeonatos mundiales que se celebrarán en la mencionada localidad. Por ese motivo, desea llevar a una base de datos toda la gestión relativa a participantes, alojamientos y partidas. Teniendo en cuenta que:

En el campeonato mundial de Villatortas participan jugadores y árbitros. De ambos se requiere conocer el número de asociado, nombre, dirección, teléfono de contacto y campeonatos en los que han participado (como jugador o como árbitro). De los jugadores se precisa además el nivel de juego en una escala de 1 a 10. 
...
Cada partida se celebra en una de las salas de las que pueden disponer los hoteles. Se desea conocer el número de entradas vendidas en la sal para cada partida. De cada sala, se desea conocer la capacidad y medios de que dispone (radio, televisión, vídeo, …) para facilitar la retransmisión de los encuentros. Una sala puede disponer de varios medios distintos.

De cada partida se pretende registrar todos los movimientos que la componen. La identificación de movimiento se establece en base a un número de orden dentro de cada partida. Para cada movimiento se guarda la jugada (5 posiciones) y un breve comentario realizado por un experto.

---

Diseño conceptual:  

![Diseño de bases de datos.](img/actividades/ud4_act_img2.png)
...
Existen productores básicos de electricidad que se identifican por un nombre, de los cuales interesa su producción media, producción máxima y fecha de entrada en funcionamiento. Estos productores básicos pertenecen a algunas de las siguientes categorías: Central Hidroeléctrica, Central Solar, Central Nuclear o
...
![Diseño de bases de datos.](img/actividades/ud4_act_img3.png)
...
afectadas, en los económicos las materias primas disputadas y en los raciales las etnias enfrentadas.
...
![Diseño de bases de datos.](img/actividades/ud4_act_img4.png)
...
![Diseño de bases de datos.](img/actividades/ud4_act_img5.png)
...
![Diseño de bases de datos.](img/actividades/ud4_act_img6.png)
...
La coordinadora nacional de Organizaciones No Gubernamentales (ONG’s) desea mantener una base de
datos de las asociaciones de este tipo que existen en nuestro país. Para ello necesita almacenar información sobre cada asociación, los socios que la componen, los proyectos que realizan y los trabajadores de las mismas. 
...
![Diseño de bases de datos.](img/actividades/ud4_act_img7.png)

Se pida transformación a esquema relacional.
...
![Diseño de bases de datos.](img/actividades/ud4_act_img8.png)
...
![Diseño de bases de datos.](img/actividades/ud4_act_img9.png)
...
![Diseño de bases de datos.](img/actividades/ud4_act_img10.png)
